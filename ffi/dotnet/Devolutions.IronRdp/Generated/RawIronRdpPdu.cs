...
public partial struct IronRdpPdu
{
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, EntryPoint = "IronRdpPdu_destroy", ExactSpelling = true)]
    public static unsafe extern void Destroy(IronRdpPdu* self);
}
